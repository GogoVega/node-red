...
module.exports = {
    init: function(settings,runtimeAPI) {
        ...
        // Semver
        adminApp.post("/semver/compare", needsPermission("engines.read"), semver.compare, apiUtil.errorHandler);
        adminApp.post("/semver/check-engines", needsPermission("engines.read"), semver.checkEngines, apiUtil.errorHandler);
        adminApp.post("/semver/satisfies", needsPermission("engines.read"), semver.satisfies, apiUtil.errorHandler);
