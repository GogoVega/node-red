...
export declare namespace widgets {
    ...
    interface TypedInputTypeDefinition {
         ...
         */
        autoComplete?: (value: string) => Array<{ value: string; label: string }>;
        autoComplete?: (value: string, done: (result?: Array<{ value: string; label: string }>) => void) => void;
