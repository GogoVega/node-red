...
export declare namespace nodes {
    ...
    interface SubflowOutput extends SubflowInput {
        direction: "out";
    }
...
export interface Nodes {
     ...
     */
    createCompleteNodeSet(options?: { credentials?: boolean, dimensions?: boolean }): nodes.NodeObject[];
...
export interface Palette {
    ...
    init(): void;
    /** @internal */
    add(type: string, definition: nodes.PropertyDefinition): void;
...
interface PaletteEditor {
    init(): void;
    install(entry: nodes.InstallModuleEntry, container: HTMLElement, done: (error: Error) => void): void;
    install(entry: nodes.InstallModuleEntry, container: HTMLElement, done: (success: JQuery.jqXHR) => void): void;
}
...
export interface Utils {
    ...
    getDefaultNodeIcon(
        def: nodes.PropertyDefinition,
        node?: nodes.BaseNode,
    ): { module: string; file: string; };
    getNodeIcon(def: nodes.PropertyDefinition, node?: nodes.BaseNode): string;
    getNodeLabel(node: nodes.BaseNode, defaultLabel?: string): string;
    getNodeColor(type: string, def: nodes.PropertyDefinition): string;
    getPaletteLabel(type: string, def: nodes.PropertyDefinition): string;
